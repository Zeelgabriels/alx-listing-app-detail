        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              Find your perfect property from over 2 million listings worldwide. 
              We make it easy to discover and book unique accommodations.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-blue-400 transition-colors">Trust & Safety</a></li>
            </ul>
          </div>
        </div>
